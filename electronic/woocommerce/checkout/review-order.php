...
<table class="table table-bordered table-hover">
	<thead>
		<tr>
			<td class="text-left"><?php esc_html_e( 'Product Name', 'woocommerce' ); ?></td>
			<td class="text-left"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></td>
			<td class="text-left"><?php esc_html_e( 'Unit Price', 'woocommerce' ); ?></td>
			<td class="text-left"><?php esc_html_e( 'Total', 'woocommerce' ); ?></td>
		</tr>
	</thead>
	<tbody>
		<?php
